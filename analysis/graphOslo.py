...
result = test_capacity_trains([static_model, moving_model], [osloMetro.metro_specifications], max_trains=20, repetitions=1, verbose=False)
...
plt.title('Comparison Oslo vs Simulation', fontsize=14)
plt.legend()
