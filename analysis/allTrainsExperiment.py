...
# trains = get_trains(10, train_specifications, train_distribution)
# add_trains(static_model, trains)
# for i in range(600):
#     static_model.step()
# visualize(static_model, 1000, "he?")
#
# add_trains(moving_model, trains)
# for i in range(600):
#     moving_model.step()
# visualize(moving_model, 1000, "he? moving")
